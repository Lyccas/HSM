...
public class Main extends TimerTask {
	...
	/**
	 * This method is automatically executed again and again by the Timer
	 * Here, every run consists of one time-step of the game until it is finished
	 */
	@Override
	public void run() {
		time++;
